    ...
    <>
      <div className="relative">
        <Button variant="ghost" size="icon" onClick={() => setSheetOpen(true)}>
          <ShoppingCartIcon />
          <span className="absolute right-0 top-0 flex size-5 items-center justify-center rounded-full bg-primary text-sm text-primary-foreground">
          ...
          <div className="flex items-center justify-between gap-5">
            <div className="space-y-0.5">
              ...
              <p className="text-bold">
                {/* @ts-expect-error, to avoid error in subtotal */}
