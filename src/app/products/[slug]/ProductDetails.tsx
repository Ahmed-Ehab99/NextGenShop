...
import { checkInSock, findVariant } from "@/lib/utils";
...
export default function ProductDetails({ product }: ProductDetailsProps) {
  ...
  const inStock = checkInSock(product, selectedOptions);
  const availableQuantity =
    selectedVariant?.stock?.quantity ?? product.stock?.quantity; // (??): if left hand is null or undefined, the variable equal right hand
  const availableQuantityExceeded =
    !!availableQuantity && quantity > availableQuantity; // (!!): converte the variable to boolean value
    ...
    <div className="flex flex-col gap-10 md:flex-row lg:gap-20">
      ...
      <div className="basis-3/5 space-y-5">
        ...
        <ProductOptions
          ...
          setSelctedOptions={setSelectedOptions}
        />
